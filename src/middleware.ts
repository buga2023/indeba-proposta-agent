...
const ROTAS_API = ["/api/montar", "/api/pdf", "/api/montar-estruturado", "/api/catalogo", "/api/propostas", "/api/prospectar", "/api/financeiro", "/api/contrato", "/api/rag", "/api/feedback", "/api/cobranca", "/api/compras"];
...
export const config = {
  matcher: ["/", "/api/montar", "/api/pdf", "/api/montar-estruturado", "/api/catalogo", "/api/propostas", "/api/prospectar", "/api/financeiro", "/api/contrato", "/api/contrato/:path*", "/api/rag", "/api/feedback", "/api/cobranca", "/api/compras"],
};
